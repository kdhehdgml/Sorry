...
void Kar98::Load(LPCTSTR path, LPCTSTR filename)
{
...
void Kar98::SetupBoneMatrixPointers(LPD3DXFRAME pFrame)
{
...
void Kar98::SetupBoneMatrixPointersOnMesh(LPD3DXMESHCONTAINER pMeshContainerBase)
{
	DWORD numBones;
...
void Kar98::UpdateFrameMatrices(LPD3DXFRAME pFrame, LPD3DXFRAME pParent)
{
...
void Kar98::DrawFrame(LPD3DXFRAME pFrame)
{
	m_numFrame++;
...
void Kar98::DrawMeshContainer(LPD3DXFRAME pFrame)
{
...
void Kar98::DrawSkeleton(LPD3DXFRAME pFrame, LPD3DXFRAME pParent)
{
	FRAME_EX* pFrameEx = (FRAME_EX*)pFrame;
...
void Kar98::SetAnimationIndex(int nIndex, bool isBlend)
{
