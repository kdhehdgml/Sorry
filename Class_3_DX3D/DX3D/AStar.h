...
public:
	...
	void TrenchFindPath(D3DXVECTOR3 startPos, D3DXVECTOR3 destPos,
		OUT vector<int>& vecIndex);
private:
	void RestNodes();
	int FindClosestNode(const D3DXVECTOR3 &pos);
	int TrenchFindClosestNode(const D3DXVECTOR3 &pos);
