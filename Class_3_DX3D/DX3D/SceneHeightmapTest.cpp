...
SceneHeightmapTest::SceneHeightmapTest()
{
	m_pHeightMap = NULL;
...
void SceneHeightmapTest::Update()
{
	//m_CreateSmog->Update();
...
void SceneHeightmapTest::Render()
{
...
void SceneHeightmapTest::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
